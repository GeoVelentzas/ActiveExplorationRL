...
px2 = obj.map.pos2(1); py2 = obj.map.pos2(2); c2=[0.50 0.50 0.50]; r2=0.9;
px3 = obj.map.pos3(1); py3 = obj.map.pos3(2); c3=[0.89 0.99 0.89]; r3=0.8;
px4 = obj.map.pos4(1); py4 = obj.map.pos4(2); c4=[0.89 0.99 0.89]; r4=0.8;
