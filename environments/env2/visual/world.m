    ...
    methods
        ...
        function obj = robotAction(obj, act, param)
            ...
            switch act
                ...
                case 3
                    % approach pos3...
                    obj.robot.head_angle_des = atan2(obj.map.pos4(2)-obj.robot.head_pos(2),obj.map.pos4(1)-obj.robot.head_pos(1));
                    while norm(obj.map.pos4 - obj.robot.right_arm_pos)>0.01
                    ...
                    if ismember(1,obj.map.layer3)&&(norm(obj.cube1.pos-obj.map.pos4)<0.1)
                        obj.cube1.grabbed = true;
                    elseif ismember(2,obj.map.layer3)&&(norm(obj.cube2.pos-obj.map.pos4)<0.1)
                        obj.cube2.grabbed = true;
                    elseif ismember(3,obj.map.layer3)&&(norm(obj.cube3.pos-obj.map.pos4)<0.1)
                        obj.cube3.grabbed = true;
                    end
                    %go to center position
                    obj.robot.head_angle_des = atan2(obj.map.pos2(2)-obj.robot.head_pos(2),obj.map.pos2(1)-obj.robot.head_pos(1));
                    ...
                    if obj.cube1.grabbed
                        obj.cube1.grabbed = false;
                        obj.map.layer3(4) = obj.map.layer2(4);
                        obj.map.layer2(4) = obj.map.layer1(4);
                        obj.map.layer1(4) = 0;
                        obj.map.layer1(2) = obj.map.layer2(2);
                        obj.map.layer2(2) = obj.map.layer3(2);
                        obj.map.layer3(2) = 1;
                ...
                case 6
                    ...
                    if obj.cube1.grabbed
                        ...
                        obj.map.layer2(2) = obj.map.layer1(2);
                        obj.map.layer1(2) = 0;
                        obj.map.layer1(4) = obj.map.layer2(4);
                        obj.map.layer2(4) = obj.map.layer3(4);
                        obj.map.layer3(4) = 1;
                    elseif obj.cube2.grabbed
                        obj.cube2.grabbed = false;
                        obj.map.layer3(2) = obj.map.layer2(2);
