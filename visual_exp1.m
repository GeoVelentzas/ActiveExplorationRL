...
M2S1 = nanmean(M2S1); 
plot(1:5000, M2S1(1:5000), '.','Color', b(2,:)); hold on;

for i=1:size(A1,1);
    M1S1 = [M1S1; repnan(A1(i,:,1))];
end
M1S1 = nanmean(M1S1); 
plot(5001:10001, M1S1(5001:10001), '.', 'Color', b(1,:));
...
M3S2 = nanmean(M3S2); 
plot(1:5000, M3S2(1:5000), '.','Color', b(3,:)); hold on;

for i=1:size(A4,1);
    M4S2 = [M4S2; repnan(A4(i,:,2))];
end
M4S2 = nanmean(M4S2); 
plot(5001:10001, M4S2(5001:10001), '.', 'Color', b(4,:));
xlim([0 10001]);  ylim([-100 100]);
...
M4S3 = nanmean(M4S3); 
plot(1:5000, M4S3(1:5000), '.','Color', b(4,:)); hold on;

for i=1:size(A3,1);
    M3S3 = [M3S3; repnan(A3(i,:,3))];
end
M3S3 = nanmean(M3S3); 
plot(5001:10001, M3S3(5001:10001), '.', 'Color', b(3,:));
xlim([0 10001]);  ylim([-100 100]);
...
for i=1:size(A2,1);
    M2S4 = [M2S4; repnan(A2(i,:,4))];
end
M2S4 = nanmean(M2S4); 
plot(5001:10001, M2S4(5001:10001), '.', 'Color', b(2,:));
xlim([0 10001]);  ylim([-100 100]);
...
M6S5 = nanmean(M6S5); 
plot(1:5000, M6S5(1:5000), '.','Color', b(6,:)); hold on;

for i=1:size(A5,1);
    M5S5 = [M5S5; repnan(A5(i,:,5))];
end
M5S5 = nanmean(M5S5); 
plot(5001:10001, M5S5(5001:10001), '.', 'Color', b(5,:));
xlim([0 10001]);  ylim([-100 100]);
%%
subplot(3,2,6);
